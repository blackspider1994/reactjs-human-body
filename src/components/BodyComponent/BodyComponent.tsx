    ...
    <Wrapper className="human-body">
      {Object.keys(svgElements)
        ...
        .map((part: string) => {
          ...
          let type="";
          if (parts[part]) {
            selected = parts[part].selected;
            type = parts[part].type;
            
            }
          return svgElements[part](selected,type)
        })}
    </Wrapper>
  )
}
